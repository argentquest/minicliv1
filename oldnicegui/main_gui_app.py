"""
Main GUI Application for Code Chat with AI

This module contains the main tkinter-based GUI application logic.
Moved from minicli.py to consolidate all tkinter code in the oldnicegui folder.
"""
...
class SimpleModernCodeChatApp:
 ...
 • Theme support and modern UI components"""
        ...
        # Close button
        close_btn = tk.Button(about_frame, text="Close",
                             command=about_window.destroy,
                             bg=theme.colors['btn_primary'],
                             fg=theme.colors['btn_text'])
        close_btn.pack()
