...
**WhisperCode** is a powerful full-stack web application that brings AI assistance directly to your development workflow. Select any codebase, choose from specialized AI experts, and get intelligent insights, code reviews, and architectural guidance through an intuitive web interface.
...
2. **Set up your development environment:**
   ```bash
   git clone https://github.com/your-username/WhisperCode.git
   cd WhisperCode
